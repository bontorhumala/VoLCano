...
class UniversalTelegramBot
{
  public:
    ...
    bool sendSticker(String chat_id, String sticker);
    bool sendMessageWithReplyKeyboard(String chat_id, String text, String parse_mode, String keyboard, bool resize = false, bool oneTime = false, bool selective = false, bool force_reply = false);
    bool sendPostMessage(JsonObject& payload);
    bool sendPostSticker(JsonObject& payload);
